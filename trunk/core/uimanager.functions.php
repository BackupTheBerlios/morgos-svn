...
$this->functions['admin_modules_item'] = array ('name' => 'ADMIN_MODULES_ITEM', 'params' => array ('NAME', 'AUTHORIZED_ONLY', 'LANGUAGE', 'NSUBMIT', 'ADDPAGE', 'DELETEPAGE', 'DELETEMODULE', 'EDITPAGE'));
